...
and Redis:get(black.."lock_cleaner"..msg_chat_id) then
print("Clener >>> ")
Devblack:sadd(black.."black:cleaner"..msg_chat_id,msg.id_)
Timerr = Redis:get(black..':Timer_Cleaner:'..msg_chat_id)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
Redis:setex(black..":SetTimerCleaner:"..msg_chat_id..msg.id_,Timerr or 21600,true)  
local Cleaner = Redis:get(black.."black:cleaner"..msg_chat_id)
for k,v in pairs(Cleaner) do
if not Redis:get(black.."black:cleaner"..msg_chat_id..v) then
DeleteMessage(msg_chat_id, {[0] = v}) 
Devblack:srem(black.."black:cleaner"..msg_chat_id,v)
