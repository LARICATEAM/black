...
ControllerAll = false
local ListSudos ={Sudo_Id,1573309498,938929,2078351596,2112,2178}  
...
elseif tonumber(UserId) == 938929 then
Status = 'مبرمج السورس'
...
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 938929 then
...
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*⌔︰ ارسل الكلمه لزخرفتها عربي او انكليزي يعمري*","md",true) 
