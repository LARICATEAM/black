...
local N = (Redis:get(black.."Name:Bot") or "لاريكا")
...
--download('https://raw.githubusercontent.com/LARICATEAM/black/master/black.lua','black.lua')
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/The_1666/428&caption=".. URL.escape(baniusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/vvivvvvviv/9&caption=".. URL.escape(baniusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/The_1666/429&caption=".. URL.escape(baniusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/The_1666/430&caption=".. URL.escape(baniusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/vvivvvvviv/8&caption=".. URL.escape(baniusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/vvivvvvviv/7&caption=".. URL.escape(baniusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/vvivvvvviv/6&caption=".. URL.escape(baniusername).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
keyboardd.inline_keyboard = {
{
{text = '< Developers black  >', url = "https://t.me/sSs_sSs"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/BBBBRR/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
{
{text = '† صورتك السابقه †', callback_data= msg.sender.user_id..'/ban1'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(ban_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
{
{text = '† صورتك السابقه †', callback_data= msg.sender.user_id..'/ban89'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(ban_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
{
{text = 'ꪀꫀ᥊𝓽  ◀️', data =msg.sender.user_id..'/'.. 'NextSeting'}
},
{
{text = '٬ 𝗁𝗂𝖽𝖾 𝗂𝗍 † ٫ ', data =msg.sender.user_id..'/'.. 'delAmr'}
},
...
data = {
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗀𝖺𝗆𝖾𝗌 🦖', data = msg.sender.user_id..'/normgm'}, 
},
{
{text = '𝖺𝖽𝗏𝖺𝗇𝖼𝖾𝖽 𝗀𝖺𝗆𝖾𝗌 🦇', data = msg.sender.user_id..'/degm'}, 
},
{
{text = '٬ 𝙇𝙖𝙍𝙞𝙘𝙖 † ٫', url = 't.me/LARICATEAM'}, 
},
...
local Namebot = (Redis:get(black.."Name:Bot") or "لاريكا")
local BotName = {
'اسمي  '..Namebot..' 🦇',
}
...
if text == (Redis:get(black.."Name:Bot") or "لاريكا") then
local photo = LuaTele.getUserProfilePhotos(black)
local ban = LuaTele.getUser(black)
local Namebot = (Redis:get(black.."Name:Bot") or "لاريكا")
local BotName = {
...
" مسامح الل ظلمك؟", 
" ممثلك الافضل؟", 
" ممكن تكول رساله لحد مش هيشوفها؟", 
...
"ويُرهقني أنّي مليء بما لا أستطيع كوله.✨",
...
"حين تكول والدتك ستندم ع فعل ذالك ستندم عليه غالبا.. ",
...
if text == "نكته" or text == "كولي نكته" or text == "عايز اضحك" then
if Redis:get(black.."Status:Games"..msg.chat_id) then
local vBandav_Msg = { 
" مرة واحد مصري دخل سوبر ماركت في الكويت عشان يشتري ولاعة..    راح عشان يحاسب بيكوله الولاعة ديه بكام؟   قاله دينار..  قاله منا عارف ان هي نار بس بكام 🤓😂", 
"بنت حبت تشتغل مع رئيس عصابة..   شغلها في غسيل الأموال 🤓😂 ", 
"واحد بيشتكي لصاحبه بيكوله أنا مافيش حد بيحبني ولا يفتكرني أبدًا، ومش عارف أعمل إيه.. قاله سهلة.. استلف من الناس فلوس هيسألوا عليك كل يوم! 🤓😂",
...
"واحدة عملت حساب وهمي ودخلت تكلم جوزها منه.. ومبسوطة أوي وبتضحك.. سألوها بتضحكي على إيه؟ قالت لهم أول مرة يكول لي كلام حلو من ساعة ما اتجوزنا. 🤓😂",
"بنت حبت تشتغل مع رئيس عصابة..   شغلها في غسيل الأموال 🤓😂",
"مره واحد اشترى فراخ..   علشان يربيها فى قفص صدره.🤓😂",
"مرة واحد من الفيوم مات..   أهله صوصوا عليه.🤓😂",
"ﻣﺮه واﺣﺪ ﻣﺴﻄﻮل ﻣﺎﺷﻰ ﻓﻰ اﻟﺸﺎرع ﻟﻘﻰ مذﻳﻌﻪ ﺑﺘﻘﻮﻟﻪ ﻟﻮ ﺳﻤﺤﺖ ﻓﻴﻦ اﻟﻘﻤﺮ؟    ﻗﺎﻟﻬﺎ اﻫﻮه..   ﻗﺎﻟﺘﻠﻮ ﻣﺒﺮوك ﻛﺴﺒﺖ ﻋﺸﺮﻳﻦ ﺟﻨﻴﻪ..   ﻗﺎﻟﻬﺎ ﻓﻰ واﺣﺪ ﺗﺎﻧﻰ ﻫﻨﺎك اﻫﻮه.🤓😂",
"مره واحد شاط كرة فى المقص..   اتخرمت. 🤓😂",
"مرة واحد رايح لواحد صاحبه.. فا البواب وقفه بيكول له انت طالع لمين.. قاله طالع أسمر شوية لبابايا.. قاله يا أستاذ طالع لمين في العماره 🤓😂",
} 
return LuaTele.sendText(msg_chat_id,msg_id,vBandav_Msg[math.random(#vBandav_Msg)],'md')
end
end
...
local CmdStart = '*\n⌔︰ أهلآ بك في بوت '..(Redis:get(black.."Name:Bot") or "لاريكا")..
...
{
{text = '† صورتك السابقه † ', callback_data =IdUser..'/ban1'},{text = '† صورتك السابقه †', callback_data =IdUser..'/delAmr'}, 
},
}
...
{
{text = '† صورتك السابقه † ', callback_data =IdUser..'/ban2'},{text = '† صورتك السابقه †', callback_data =IdUser..'/ban0'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '† صورتك السابقه † ', callback_data =IdUser..'/ban3'},{text = '† صورتك السابقه †', callback_data =IdUser..'/ban1'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '† صورتك السابقه † ', callback_data =IdUser..'/ban4'},{text = '† صورتك السابقه †', callback_data =IdUser..'/ban2'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '† صورتك السابقه † ', callback_data =IdUser..'/ban5'},{text = '† صورتك السابقه †', callback_data =IdUser..'/ban3'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '† صورتك السابقه † ', callback_data =IdUser..'/ban6'},{text = '† صورتك السابقه †', callback_data =IdUser..'/ban4'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '† صورتك السابقه † ', callback_data =IdUser..'/ban7'},{text = '† صورتك السابقه †', callback_data =IdUser..'/ban5'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
data = {
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗀𝖺𝗆𝖾𝗌 🦖', data = IdUser..'/normgm'}, 
},
{
{text = '𝖺𝖽𝗏𝖺𝗇𝖼𝖾𝖽 𝗀𝖺𝗆𝖾𝗌 🦇', data = IdUser..'/degm'}, 
},
{
{text = '٬ 𝙇𝙖𝙍𝙞𝙘𝙖 † ٫', url = 't.me/LARICATEAM'}, 
},
...
{{text = '٬ 𝙇𝙖𝙍𝙞𝙘𝙖 † ٫', url = 't.me/LARICATEAM'}},
{{text = '٬ 𝗆𝖺𝗂𝗇 𝗅𝗂𝗌𝗍 † ٫', data = IdUser..'/help6'}},
}
}
local TextHelp = [[*
• 𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝗌𝗈𝗎𝗋𝖼𝖾 𝗅𝖺𝗋𝗂𝖼𝖺'𝗌 𝖼𝗎𝗍𝗍𝗂𝗇𝗀-𝖾𝖽𝗀𝖾 𝗀𝖺𝗆𝖾𝗌 
• 𝖼𝗁𝗈𝗈𝗌𝖾 𝗍𝗁𝖾 𝗀𝖺𝗆𝖾 𝖺𝗇𝖽 𝗍𝗁𝖾𝗇 𝖼𝗁𝗈𝗈𝗌𝖾 𝗍𝗁𝖾 𝖼𝗈𝗇𝗏𝖾𝗋𝗌𝖺𝗍𝗂𝗈𝗇 𝗒𝗈𝗎 𝗐𝖺𝗇𝗍 𝗍𝗈 𝗉𝗅𝖺𝗒 𝗐𝗂𝗍𝗁 ⛓️
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{
{text = '- ⤹ ٰ𝖱ِ𝖊َ𝖳ِ𝖚ٍ𝐑ِɴ 🔁.', data = IdUser..'/helpall'},
},
{
{text = '٬ 𝗁𝗂𝖽𝖾 𝗂𝗍 † ٫ ', data =IdUser..'/'.. 'delAmr'}
},
...
{
{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =IdUser..'/'.. 'NoNextSeting'}
},
{
{text = '- ⤹ ٰ𝖱ِ𝖊َ𝖳ِ𝖚ٍ𝐑ِɴ 🔁.', data = IdUser..'/helpall'},
},
...
{
{text = 'ꪀꫀ᥊𝓽  ◀️', data =IdUser..'/'.. 'NextSeting'}
},
{
{text = '- ⤹ ٰ𝖱ِ𝖊َ𝖳ِ𝖚ٍ𝐑ِɴ 🔁.', data = IdUser..'/helpall'},
},
