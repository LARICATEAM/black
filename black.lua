...
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰ تم استرجاع المجموعات من نسخه كلير')
else
...
data = {
{
{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url = 't.me/LARICATEAM'}, 
},
}
}
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪',url="https://t.me/LARICATEAM"}}
}
local msg_id = msg.id/2097152/0.5
...
local Name = '* ╭───── •⌔︰• ─────╮\n*⌔︰ [𝑆𝑂𝑈𝑅𝐶𝐸 black](t.me/LARICATEAM)*\n*⌔︰ [𝑰𝑵𝑭𝑶 𝑺𝑶𝑼𝑹𝑪𝑬](t.me/sasa_boody)*\n*⌔︰ [𝑮𝑹𝑶𝑼𝑷 𝑻𝑾𝑺](t.me/M0STAFA_6)*\n*⌔︰ [𝑫𝑬𝑽 source mostafa](t.me/M_P_L_6)*\n*⌔︰ [𝑫𝑬𝑽 source boody](t.me/BoOdY_BaSha)*\n╰───── • ⌔︰ • ─────╯\n⍟ 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻 𝑶𝑵 𝑺𝑶𝑼𝑹𝑪𝑬 ⏎*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اضف البوت الي مجموعتك✅', url = 't.me/'..UserBot..'?startgroup=new'}
...
local CmdStart = '*\n⌔︰ أهلآ بك في بوت '..(Redis:get(black.."Name:Bot") or "كلير")..
...
{
{text = '𝗅𝗈𝖼𝗄 ??𝗋𝖽𝖾𝗋𝗌', data = IdUser..'/NoNextSeting'}, {text = '𝖽𝗂𝗌𝗋𝗎𝗉𝗍𝗂𝗈𝗇 𝗈𝗋𝖽𝖾𝗋𝗌', data = IdUser..'/listallAddorrem'}, 
},
{
{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url = 't.me/LARICATEAM'}, 
},
