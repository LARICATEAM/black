...
ControllerAll = false
local ListSudos ={Sudo_Id,5049221213,1554085475,5070619367}  
...
if UserId == 5049221213 then
Status = true
elseif UserId == 1554085475 then
Status = true
elseif UserId == 5070619367 then
Status = true
...
if UserId == 5049221213 then
Status = 'ٱݪمْبرمجـۦـ غـۦـزٱݪ🦌'
elseif UserId == 1554085475 then
Status = 'ٱݪمبرمجـۦـ صٱصٱ🕊️'
elseif UserId == 5070619367 then
...
return {
Lock     = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_black)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه المسح *',
unLock   = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_black)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_black)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الكتم *',
lockKid  = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_black)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه التقييد *',
lockKick = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_black)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الطرد *',
Reply    = '[‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›](https://t.me/G8_black)\n*— — — — — — — — —\n◍ المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if tonumber(msg.sender.user_id) == 5049221213 then
msg.Name_Controller = 'ٱݪمْبرمجـۦـ غـۦـزٱݪ 🦌'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1554085475 then
msg.Name_Controller = 'ٱݪمبرمجـۦـ صٱصٱ🕊️'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5070619367 then
...
local Num_Msg_black = Redis:hget(Theblack.."black:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
...
Num_Msg_black = Redis:hget(Theblack.."black:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
local mrt = LuaTele.getUser(Theblack)
...
local blacka = 'احصائيات الـــبوت'
...
{
{text = Grosupsw, url = 'https://t.me/G8_black'}, 
},
{
{text = Usperos, url = 'https://t.me/G8_black'}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(blacka).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
local TotalMsg = Redis:get(Theblack..'black:Num:Message:User'..msg_chat_id..':'..Useriid_Info.id) or 0
local TotalEdit = Redis:get(Theblack..'black:Num:Message:Edit'..msg_chat_id..Useriid_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*◍ ايديه : '..Useriid..
'\n◍ معرفه : '..UserInfousername..
...
data = {
{
{text = '‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›', url = 't.me/G8_black'}, 
},
}
}
...
{
{text = '‹ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›', url = "https://t.me/G8_black"}
},
}
...
if text == 'بار ماكس' then
photo = "https://t.me/G8AZZAL/33"
local T =[[
𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙏𝙀𝘼𝙈 𝙈𝘼𝙓 ™ || »⁩
]]
keyboard = {} 
...
if text == 'مبرمج السورس' or text == 'غزال' or text == 'حازم' then
photo = "https://t.me/G8AZZAL/31"
local T =[[
 [ #كـارف ٱلكـل فتلاقينۍ دايمـا #مكـرؤة😉🔥 ]
...
keyboard.inline_keyboard = {
{
{text = '‹ 𝘿𝘼𝘿 𝙂8𝘼𝙕𝘼𝙇🦌 ›', url = "https://t.me/G8AZAAL"}
},
{
{text = '‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›', url = "https://t.me/G8_black"}
},
...
if text == 'مطور السورس' or text == 'صاصا' then
photo = "https://t.me/G8AZZAL/32"
local T =[[
[ كلو #حس بالأمان ف وقت #غيابي😎🔥]
...
keyboard.inline_keyboard = {
{
{text = '‹ 𝙎𝘼𝙎𝘼🕊️ ›', url = "https://t.me/S_A_S_A_1"}
},
{
{text = '‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›', url = "https://t.me/G8_black"}
},
...
if Redis:get(Theblack.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
local rep = msg.id/2097152/0.5
local m = rep +1
...
Redis:del(Theblack.."youtube"..msg.sender.user_id..msg_chat_id)
end
if Redis:get(Theblack.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = rep +1
https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/youtube7odabot/7951&reply_to_message_id="..rep)
...
🐲┇ Welcome to Source 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 [ « 𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓»](https://t.me/G8_black)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ ٱݪمْبرمجـۦـ غـۦـزٱݪ🦌 ›', url = "https://t.me/G8AZAAL"}
},
{
{text = '‹ ٱݪمبرمجـۦـ صٱصٱ🕊️ ›', url = "https://t.me/S_A_S_A_1"}
},
{
{text = '‹ ټـــۄٱصــݪ ٱݪـــسۧــۄرسۧ🤖 ›', url = "https://t.me/U_Y_HBOT"}
},
{
{text = '‹ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›', url = "https://t.me/G8_black"}
},
...
{
{text = '‹  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙓 ›', url = 't.me/black'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
...
local NamesBot = (Redis:get(Theblack.."black:Name:Bot") or "ماكس")
local BotName = {
...
if text == (Redis:get(Theblack.."black:Name:Bot") or "ماكس") then
local photo = LuaTele.getUserProfilePhotos(Theblack)
local mrt = LuaTele.getUser(Theblack)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
...
local CmdStart = '*\n🤖╖ أهلآ بك عزيزي أنا بوت'..(Redis:get(Theblack.."black:Name:Bot") or "ماكس")..
...
{
{text = 'مسح المطورين 🐉',type = 'text'},{text = 'المطورين 🐉', type = 'text'},
},
{
{text = 'مسح المطورين الثانويين 🐉',type = 'text'},{text = 'المطورين الثانويين 🐉', type = 'text'},
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'🐉︙ اهلا بك عزيزي المطور [تابع جديدنا♻️](https://t.me/G8_black) ', 'md', false, false, false, false, reply_markup)
end
end
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(Theblack.."youtube"..IdUser..ChatId,'mp3')
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(Theblack.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
