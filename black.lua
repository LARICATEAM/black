...
ControllerAll = false
local ListSudos ={Sudo_Id,868907,1573309498,2078351596,2112,2178}  
...
Status = 'مبرمج السورس'
elseif tonumber(UserId) == 868907  then
Status = 'مبرمج السورس'
...
Distinguished = Redis:sismember(black.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if tonumber(UserId) == 868907 then
Status = true
elseif tonumber(UserId) == 2112 then
Status = true
elseif tonumber(UserId) == 2178 then
...
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 868907 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
...
{
{text = 'مبرمج السورس',type = 'text'},{text = 'المبرمج بودي',type = 'text'},
},
{
