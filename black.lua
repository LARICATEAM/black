...
ControllerAll = false
local ListSudos ={Sudo_Id,1804133252,5040650961,1573309498,2112,2178}  
...
if text == 'مطور السورس' or text == 'صاصا' or text == 'مصطفي' then  
...
if text == 'مطور السورس' or text == 'مصطفي' or text == 'صاصا' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
if text == 'مطور السورس' or text == 'مصطفي' or text == 'المبرمج' or text == 'صاصا' then  
local UserId_Info = LuaTele.searchPublicChat("M_P_L_6")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
