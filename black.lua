...
ControllerAll = false
local ListSudos ={Sudo_Id,1804133252,1573309498,1573309498,2112,2178}  
...
if text == 'مبرمج السورس' or text == 'ملو' or text == 'ملاذ' then  
...
if text == 'مبرمج السورس' or text == 'ملاذ' or text == 'ملو' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
data = {
{
{text = 'موافقه 👰', data = Message_Reply.sender.user_id..'/zog1'},{text = 'لا ماتزوج واحد عار مثلك 😋', data = Message_Reply.sender.user_id..'/zog2'}, 
},
}
}
...
{
{text = 'مبرمج السورس',type = 'text'},{text = 'المطور',type = 'text'},
},
{
...
if text == 'مبرمج السورس' or text == 'ملاذ' or text == 'المبرمج' or text == 'ملو' then  
local UserId_Info = LuaTele.searchPublicChat("sSs_sSs")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
