...
if tonumber(UserId) == 2078351596 then
Status = 'المبرمج مصطفي' 
elseif tonumber(UserId) == 5040650961 then
Status = 'مبرمج السورس'
...
elseif tonumber(UserId) == 5040650961 then
Status = true
elseif tonumber(UserId) == 2078351596 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == black then
...
if tonumber(msg.sender.user_id) == 2078351596 then
msg.Name_Controller = 'المبرمج مصطفي '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2112 then
msg.Name_Controller = 'نو نيم '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5040650961 then
...
local N = (Redis:get(black.."Name:Bot") or "كلير")
...
LuaTele.sendText(msg_chat_id,msg_id,'*𖥔 عدد احصائيات البوت الكامله \n⩹━━━━𖥕black𖥕━━━━⩺\n𖥔 عدد المجموعات : '..(Redis:scard(black..'ChekBotAdd') or 0)..'\n𖥔 عدد المشتركين : '..(Redis:scard(black..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(black..'Num:Add:Bot'),"md",true)  
end
...
Redis:set(black.."allM:numdel"..msg.chat_id,Numbardel) 
...
Redis:set(black.."rb:bna"..msg_chat_id,true) 
...
if TextMsg == 'ردود السورس' then
Redis:del(black.."rb:bna"..msg_chat_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم حظره من الجروب ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تقييده في الجروب \n𖥔 لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم تقييده في الجروب \n𖥔 لمدة : "..TimeKed[1]..' '..TimeKed[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 عذرآ لا تستطيع استخدام الامر على المطور باندا *","md",true)  
end
if UserId == "2078351596" then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n𖥔 تم الغاء حظره من الجروب \nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
end
keyboard = {} 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
keyboardd.inline_keyboard = {
{
{text = '< Developers black  >', url = "https://t.me/M_P_L_6"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '< Developers black  >', url = "https://t.me/BoOdY_BaSha"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/لينك قناه الاغاني/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
if text == "صوره" then 
Abs = math.random(2,150); local Text ='*❍︙تم اختيار الصوره لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&voice=https://t.me/لينك قناه الصور/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
Redis:sadd(black.."cleaner"..msg_chat_id,msg_id)
end
...
data = {
{
{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url = 't.me/SasaXBody'}, 
},
}
}
...
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد رسائلك هنا *~ '..(Redis:get(black..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد التعديلات هنا *~ '..(Redis:get(black..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد جهاتك المضافه هنا *~ '..(Redis:get(black.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪',url="https://t.me/SasaXBody"}}
}
local msg_id = msg.id/2097152/0.5
...
local Namebot = (Redis:get(black.."Name:Bot") or "كلير")
local BotName = {
...
if text == (Redis:get(black.."Name:Bot") or "كلير") then
local photo = LuaTele.getUserProfilePhotos(black)
local ban = LuaTele.getUser(black)
local Namebot = (Redis:get(black.."Name:Bot") or "كلير")
local BotName = {
...
local CmdStart = '*\n𖥔 أهلآ بك في بوت '..(Redis:get(black.."Name:Bot") or "كلير")..
