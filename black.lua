--[[
متفرحش اووي لان فيها حاجات بايظه غير اللي اتصلح 😂😂 
لان دي كانت نسخه تيست 😂
--]]
...
ControllerAll = false
local ListSudos ={Sudo_Id,1765160742,1573309498}
...
{
{text = 'Source black', url='https://t.me/LARICATEAM'},
},
}
}
...
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊𖤓', url = "http://t.me/LARICATEAM"}},
{{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}}, 
}
local msgg = msg_id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/LARICATEAM'}, 
},
{
...
{
{text = '- قناة السورس.', url = 't.me/LARICATEAM'},{text = '- لتنصيب بوتك', url = 'https://t.me/xb8bbot'}, 
},
}
}
