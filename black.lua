...
local Num_Msg_black = Redis:hget(black.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
...
Num_Msg_black = Redis:hget(black.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ??ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
